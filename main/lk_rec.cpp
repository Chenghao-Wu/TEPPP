...
int main(int argc, char* argv[])
{
	...
	cout<<"tototal 1 chains  "<<total_num_chains<<endl;
	...
	// Loop through all pairs of chains
	for (int chain_i = 0; chain_i < total_num_chains; chain_i++) {
	...
	delete_array(coords, num);  // Changed from num_chains to num which should be total atoms
	outfile.close();
