...
TARGET=convertor ./build/jones ./build/jones_scan ./build/lk ./build/lk_rec ./build/lk_scan ./build/periodic_lk ./build/periodic_wr ./build/wr ./build/wr_scan ./build/jones_mpi ./build/lk_mpi ./build/lk_rec_mpi ./build/lk_scan_mpi ./build/periodic_lk_mpi ./build/periodic_wr_mpi ./build/wr_mpi ./build/wr_scan_mpi	./build/jones_scan_mpi

DCD_TARGET=convertor

TEMP_TARGET=convertor ./build/jones

SERIAL_TARGET=convertor ./build/jones ./build/jones_scan ./build/lk ./build/lk_rec ./build/lk_scan ./build/periodic_lk ./build/periodic_wr ./build/wr ./build/wr_scan

MPI_TARGET=convertor ./build/jones_mpi ./build/lk_mpi ./build/lk_rec_mpi ./build/lk_scan_mpi ./build/periodic_lk_mpi ./build/periodic_wr_mpi ./build/wr_mpi ./build/wr_scan_mpi	./build/jones_scan_mpi
...
./build/lk_mpi:main/lk_mpi.cpp
	@$(MKDIR_BUILD)
	$(MPICXX) $? -o $@
./build/lk_rec_mpi:main/lk_rec_mpi.cpp
	@$(MKDIR_BUILD)
	$(MPICXX) $? -o $@
